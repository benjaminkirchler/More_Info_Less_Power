% Elsevier appendix exhibit numbering: Table A.1, Fig. A.1, ...
\setcounter{table}{0}
...
\caption{Pre-treatment hourly electricity consumption by tranche and group over time. Panels are shown for each tranche. Panel labels report the number of households per group. Group sizes differ from the final analysis sample in Table~\ref{tab:recruitment} because 11 households have no pre-treatment observations (see the note to Table~\ref{tab:pre_engagement}).}
