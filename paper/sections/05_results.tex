...
Following app access, electricity consumption declines rapidly and becomes statistically distinguishable from zero after approximately two weeks. The reduction reaches a peak between weeks 3 and 11, with effect sizes ranging from about 0.34 to 0.98 kWh per day. For instance, consumption decreases by 0.572 kWh in week 3 ($p = 0.002$) and by 0.978 kWh in week 11 ($p = 0.003$). After this initial adjustment phase, the treatment effect remains negative but its statistical significance becomes intermittent: the reduction is significant at conventional levels in most weeks through week 25, and only sporadically thereafter (for example, weeks 27, 29, and 38), without a sharp cutoff. As shown in Figure \ref{fig:event_study}, the total effect remains consistently negative throughout the post-treatment period, with magnitudes of approximately 0.4–0.6 kWh. The pooled estimate beyond week 50 is around 0.55 kWh, indicating sustained reductions in electricity consumption over time. Notably, this persistence arises despite a substantial decline in app usage, suggesting that the behavioral adjustments induced by the intervention are not purely transitory. 
...
Table \ref{table:engagement_results} shows how treatment effects vary across engagement groups. A clear pattern emerges: reductions in electricity consumption are concentrated among households that interact more intensively with the application. The Sun--Abraham estimates indicate that highly engaged households reduce their consumption by approximately 12\%, while the effects for medium- and low-engagement households are smaller and not statistically distinguishable from zero.
